...
def _render_pattern_results():
    ...
    if hits.empty:
        ...
        if not view.empty:
            ...
            # The hit list is usually long, so it is shown ten at a time. A bare
            # page number tells you nothing about where you are; this shows the
            # range and moves with buttons.
            per_page = 10
            total_hits = len(view)
