...
def main():
    ...
    # Select the index
    index = st.selectbox("Select Index", ["^NSEBANK", "^NSEI", "^BSESN", "NIFTY_FIN_SERVICE.NS", "NIFTYMIDCAP150.NS", "BSE-BANK.BO"],index=0)
    ...
    if strategy_type == "Backtesting":
        ...
        interval = st.selectbox("Select Interval", ["1m", "2m", "5m", "15m", "30m", "60m","1wk"], index=3)
