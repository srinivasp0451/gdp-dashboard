...
token_id = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpc3MiOiJkaGFuIiwicGFydG5lcklkIjoiIiwiZXhwIjoxNzQ2MzQwNzQzLCJ0b2tlbkNvbnN1bWVyVHlwZSI6IlNFTEYiLCJ3ZWJob29rVXJsIjoiIiwiZGhhbkNsaWVudElkIjoiMTEwNDc3OTg3NiJ9.dfxL1pGEwjTX1WIYWpLIPYAvvwXn6KTCUrng295eAvhXDTV2QgnZnKB-HRT9MuZ_n75tJueAaDZsDPinr9p2Mg"
...
strike_price = st.number_input("Select Strike Price", min_value=0, step=50,value=22500)
    ...
    if trade_mode == "Live Trading" and order_client_id and order_access_token:
        ...
        def place_order(symbol, qty, price, order_type="buy", exchange_segment=None, product_type=None):
            ...
            order_data = dhan.place_order(
                security_id=43859,  # Security ID of the option (symbol passed as argument)
