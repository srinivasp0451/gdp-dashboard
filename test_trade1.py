...
selected_index = st.selectbox("Select Index", ["Sensex","Nifty", "Bank Nifty","Fin Nifty","Midcap Nifty","Bankex"])
...
strike_price = st.number_input("Select Strike Price", min_value=0, step=50,value=74500)
