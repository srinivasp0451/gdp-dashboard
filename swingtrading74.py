...
def render_config_ui():
    ...
    if config['dhan_enabled']:
        ...
        config['dhan_access_token'] = st.sidebar.text_input("Access Token", type="password", value="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpc3MiOiJkaGFuIiwicGFydG5lcklkIjoiIiwiZXhwIjoxNzcyODU0OTQyLCJpYXQiOjE3NzI3Njg1NDIsInRva2VuQ29uc3VtZXJUeXBlIjoiU0VMRiIsIndlYmhvb2tVcmwiOiIiLCJkaGFuQ2xpZW50SWQiOiIxMTA0Nzc5ODc2In0.oKRtH3L4DVuESTNjENUlqEavKveoAqO33psy1Hp4fLjJohh5aZQCjrp982J7fZpG4evMQOV94q3xBIfgyBZkSA")
