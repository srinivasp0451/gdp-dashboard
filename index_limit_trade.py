...
limit_price1 = st.number_input("Enter Limit1", min_value=0, step=50,value=23250)
strike_price1 = st.number_input("Select Strike Price for limit1", min_value=0, step=50,value=23250)
limit_price2 = st.number_input("Enter Limit2", min_value=0, step=50,value=23250)
strike_price2 = st.number_input("Select Strike Price for limit2", min_value=0, step=50,value=23250)
...
if trade_mode == "Live Trading":
    ...
    order_access_token = st.text_input("Access Token (for placing orders)", type="password",value='eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpc3MiOiJkaGFuIiwicGFydG5lcklkIjoiIiwiZXhwIjoxNzQ1NjU3NjM0LCJ0b2tlbkNvbnN1bWVyVHlwZSI6IlNFTEYiLCJ3ZWJob29rVXJsIjoiIiwiZGhhbkNsaWVudElkIjoiMTEwNDc3OTg3NiJ9.4tY9UsL-gr50xuzorRYr5mVJNUVfxmepeMHgA4mypyDUfBYZ0l1qSK3NqTTjaGVHKZLDPRnRMk4SNm8jiXMbDg')
else:
